...
public class ClientVoterThread implements AutoCloseable {
  ...
  private boolean register() throws TimeoutException {
    if (!mgr.isConnected()) {
  ...
  public void operate(Consumer<ClientVoterManager> voteRequest) throws TimeoutException {
  ...
  public CompletableFuture<?> operational() {
    return operational;
  }
}
